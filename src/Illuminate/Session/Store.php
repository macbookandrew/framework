...
class Store implements Session
{
     ...
     *
     * @param  string|\BackedEnum|\UnitEnum|array  $key
     * @return bool
     */
     ...
     *
     * @param  string|\BackedEnum|\UnitEnum  $key
     * @param  mixed  $default
     * @return mixed
     */
     ...
     *
     * @param  string|\BackedEnum|\UnitEnum|null  $key
     * @return bool
     */
    ...
    {
        $keys = collect($keys)->map(fn ($key) => enum_value($key))->all();
